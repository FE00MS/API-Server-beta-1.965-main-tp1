...
$(document).ready(() => {
    ...
    console.log("Document ready, initializing image uploaders...");
    initImageUploaders();
});
...
function initImageUploaders() {
    $('.imageUploader').each(function () {
        ...
        let imageData = $(this).attr('imageSrc') || '/images/no-image.png';
        $(this).append(`<img 
        ...
        console.log(`Initializing uploader with imageSrc: ${imageData} and newImage: ${newImage}`);
